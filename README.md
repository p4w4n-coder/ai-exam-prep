...
## AdSense / publisher-content changes in the revised build

This revision is intentionally structured so interactive quiz screens are not used as ad containers. The revised build removes the in-quiz and study-page advertisement placeholders, adds substantive AIF-C01 educational material to the home/study experience, and changes exam-positioning language to describe the questions as independently written practice content.

Before requesting another publisher review, verify that your deployed site also has working navigation and accessible policy/contact pages appropriate to your business, and only place Google-served ads on pages where the publisher content is the main reason for the visit.

The AIF-C01 guide in `src/data/aifStudyGuide.js` follows the five domains and weightings in the uploaded AWS exam guide.
