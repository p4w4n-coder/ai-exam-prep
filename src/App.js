  ...
  return (
    <div className="home">
        ...
        <div className="container">
          ...
          <div className="tips-grid">
            <div className="tip-card">
              ...
              <h3>Read Study Notes First</h3>
              <p>Start with Study Notes to learn key concepts and exam traps before attempting practice questions.</p>
            </div>
            <div className="tip-card">
              <div className="tip-icon">🎯</div>
              <h3>Start with Set 1</h3>
              <p>Each set covers different topics. Set 1 is calibrated easy-to-medium. Later sets increase difficulty.</p>
            </div>
            <div className="tip-card">
              <div className="tip-icon">📝</div>
            ...
            <div className="tip-card">
              ...
              <h3>Time Yourself</h3>
              <p>AB-731: 45 seconds per question. CPMAI: 80 seconds per question. Practice under time pressure.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="site-footer">
        <div className="container">
          <p>
            <strong>AIExamReady</strong> · Free practice questions for AB-731 and PMI-CPMAI ·
