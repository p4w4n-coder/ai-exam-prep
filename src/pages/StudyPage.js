...
import AIF_STUDY_GUIDE from "../data/aifStudyGuide";
...
function ExamNotes({ data, onBack, isAif = false }) {
  return (
    <div className="exam-notes">
      ...
      <div className="sections-notes">
        ...
        <div className="sections-notes-list">
          {(data.sections || data.domains).map((section) => (
      ...
      <div className="study-cta">
        ...
        <p>Practice with original questions and review the explanation after each attempt.</p>
      </div>
    </div>
  );
}
    ...
    <div className="study-page">
      <div className="study-home">
        ...
        <div className="study-cards">
          {[...Object.entries(STUDY_NOTES), ["aif-c01", AIF_STUDY_GUIDE]].map(([key, exam]) => (
            <div
              key={key}
            ...
            >
              ...
              <div className="study-card-content">
                ...
                <div className="study-card-meta">
                  ...
                  <span>·</span>
                  <span>{(exam.sections || exam.domains).length} domains</span>
                </div>
                <div className="study-card-traps">
                  <span className="trap-preview-label">Focus:</span>
                  <span className="trap-preview-text">{exam.topTraps?.[0] || exam.domains[0].title}</span>
                </div>
        ...
        <div className="study-tip">
          ...
          <p><strong>How to use these notes:</strong> Start with the domain overview, expand each topic, and use the explanations to identify concepts you need to revisit. Finish with original practice questions to test retention.</p>
        </div>
      </div>
    </div>
  );
