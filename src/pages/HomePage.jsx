...
/*
  ...
  IMPORTANT:
  This app does not use URL routing for its internal pages. App.js controls
  navigation through onStart(), onStudy(), and onAbout() callbacks.
*/
...
export default function HomePage({ quizzes = [], onStart, onStudy, onAbout }) {
  // Prefer the first AIF-C01 practice set for the primary CTA, while still
  // working if that dataset changes in the future.
  const defaultQuiz =
    ...
    <div className="aier-home" ref={revealRef}>
          ...
          <div className="aier-container">
            ...
            <div className="aier-paths">
              {certifications.map((cert) => (
                <button type="button" className="aier-path" onClick={startPractice} key={cert.provider}>
      ...
      <footer className="aier-footer">
        <div className="aier-container aier-footer-inner">
          <button type="button" className="aier-footer-link" onClick={openAbout}>© AIExamReady · Independent study resource</button>
