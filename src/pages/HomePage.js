      ...
      <section className="why-section">
        <div className="container">
          <div className="why-grid">
            {[
              { icon: "⚡", title: "Targeted Practice", text: "Questions mapped to real exam domains and service-level distinctions." },
              { icon: "🎯", title: "Identify Weak Areas", text: "Section-level scoring shows exactly where to focus your study time." },
              { icon: "📈", title: "Exam-Ready Format", text: "Scenario-based questions that match the real exam style and difficulty." },
            ].map(w => (
