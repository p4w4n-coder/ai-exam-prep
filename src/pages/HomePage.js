    ...
    <div className="home">
      ...
      <header className="site-header">
        <div className="header-inner">
          <div className="logo">
            <img className="logo-mark" src={`${process.env.PUBLIC_URL || ""}/favicon.png`} alt="AIExamPrep" />
            <div>
      ...
      <footer className="site-footer">
        <div className="container">
          <div className="footer-inner">
            <div>
              <div className="footer-logo"><img className="footer-logo-mark" src={`${process.env.PUBLIC_URL || ""}/favicon.png`} alt="" /> AIExamPrep</div>
